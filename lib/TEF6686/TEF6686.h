...
static const uint8_t DSP_INIT[] PROGMEM = {
    ...
    0x03, 0x1C, 0x00, 0x00, // Clear Required Initialization Control
    0x03, 0x1C, 0x00, 0x75, // Set Required Initialization Control
    ...
    0x03, 0x1C, 0x00, 0x00, // Clear Required Initialization Control
    0x03, 0x14, 0x00, 0x01, // â€Startâ€™ brings the device into â€idle stateâ€™
    ...
    0x05, 0x40, 0x05, 0x01, 0x00, 0x01,                         // APPL_Activate brings the device into â€active stateâ€™ = radio standby
    0x02, 0xFF, 100,                                            // Wait 100 mS
    // 0x05, 0x20, 0x16, 0x01, 0x00, 0x01,                                      //FM_Set_ChannelEqualizer (1, 1)
    0x07, 0x20, 0x17, 0x01, 0x00, 0x00, 0x03, 0xE8,                         // FM_Set_NoiseBlanker (1, 0, 1000)
    0x09, 0x20, 0x18, 0x01, 0x00, 0xD2, 0x00, 0xD2, 0x00, 0xFA,             // FM_Set_NoiseBlanker_Options (1, 210, 210, 250)
    ...
    0x07, 0x20, 0x2D, 0x01, 0000, 0x00, 0x00, 0x00,                         // FM_Set_Softmute_Max (1, 0, 0)
    0x0B, 0x20, 0x32, 0x01, 0x00, 0xC8, 0x07, 0xD0, 0x00, 0x0a, 0x00, 0x50, // FM_Set_HighCut_Time (1, 200, 2000, 10, 80)
    0x09, 0x20, 0x35, 0x01, 0x00, 0x03, 0x00, 0x96, 0x00, 0xC8,             // FM_Set_HighCut_Noise (1, 3, 150, 200)
    0x09, 0x20, 0x36, 0x01, 0x00, 0x03, 0x00, 0x78, 0x00, 0xA0,             // FM_Set_HighCut_Mph (1, 3, 120, 160)
    0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x1B, 0x58,                         // FM_Set_HighCut_Max (1, 1, 7000)
    0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x32,                         // FM_Set_Lowcut_Max (1, 1, 50)
